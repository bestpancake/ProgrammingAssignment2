...
## set the value of the inverse of the matrix - setrev
## get the value of the inverse of the matrix - getrev
...
makeCacheMatrix <- function(x = matrix()) {
  ...
  get<-function() x
  setrev<-function(rev) m <<-apply(x,1,rev)
  getrev<-function() m
